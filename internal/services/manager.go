...
func NewManager(ctx context.Context, dbDir, brokersConfPath string, configuredBrokers []string,
	usersConfig users.Config, pamConfig pam.Config) (m Manager, err error) {
