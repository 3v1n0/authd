...
// IsUniqueUserName returns if an user exists for the given name.
...
// IsUniqueGroupName returns if an user exists for the given UID.
...
// IsUniqueUID returns if an user exists for the given UID.
...
// IsUniqueGID returns if an user exists for the given UID.
