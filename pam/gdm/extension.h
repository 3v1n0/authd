...
#include "extensions/gdm-private-json-pam-extension.h"
...
static inline void
gdm_private_json_request_init (GdmPamExtensionJSONProtocol *request,
                               const char                  *proto_name,
                               unsigned int                 proto_version,
                               const char                  *json)
{
  GDM_PAM_EXTENSION_PRIVATE_JSON_REQUEST_INIT (request, proto_name,
                                               proto_version, json);
}
