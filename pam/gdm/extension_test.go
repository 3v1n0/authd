...
func TestGdmExtensionSupport(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"Extensions are advertised": {
			advertisedExtensions: []string{PamExtensionPrivateJSON, "foo"},
			checkExtensions:      []string{PamExtensionPrivateJSON, "foo"},
			supportedExtensions:  []string{PamExtensionPrivateJSON, "foo"},
		},

		"The private string extension unsupported if not advertised": {
			checkExtensions:     []string{PamExtensionPrivateJSON},
			supportedExtensions: nil,
		},
	}
