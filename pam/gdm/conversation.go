...
func sendToGdm(pamMt pam.ModuleTransaction, data []byte) ([]byte, error) {
	binReq := NewBinaryStringProtoRequest(data)
	...
	// 		msg := (*stringProtoMessage)(unsafe.Pointer(*(**[]byte)(ptr)))
	// 		return decodeStringProtoMessage(pam.BinaryPointer(msg))
	// 	})
	// }
	return binRes.Decode(decodeStringProtoMessage)
}
