...
inline bool gdm_choices_list_supported (void) {
    return GDM_PAM_EXTENSION_SUPPORTED(GDM_PAM_EXTENSION_CHOICE_LIST);
}

GdmPamExtensionChoiceListRequest *
gdm_choices_request_create(const char *, size_t);

void gdm_choices_request_set (GdmPamExtensionChoiceListRequest *, size_t i,
                              const char *key, const char *value);

char * gdm_choices_request_ask (pam_handle_t *pamh, GdmPamExtensionChoiceListRequest *);
