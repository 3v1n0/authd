...
func newBrokerSelectionModel(client authd.PAMClient, pamh pamHandle,
	interactiveTerminal bool) brokerSelectionModel {
...
func (m brokerSelectionModel) Update(msg tea.Msg) (brokerSelectionModel, tea.Cmd) {
	...
	case UsernameAndBrokerListReceived:
		...
		i, err := PromptForInt(m.pamh, "= Broker selection =", choices, "Select broker: ")
		if err != nil {
			return m, nil
