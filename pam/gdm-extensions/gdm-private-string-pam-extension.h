...
{ \
        ...
        strncpy ((char *)(request)->protocol_name, proto_name, sizeof ((request)->protocol_name)); \
...
{ \
        ...
        strncpy ((char *)(response)->protocol_name, proto_name, sizeof ((response)->protocol_name)); \
