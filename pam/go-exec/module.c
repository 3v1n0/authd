...
static void
notify_conversation_done (ConversationInvocation *conversation_invocation)
{
  NotifyConversationData *notify_data = conversation_invocation->callback_data;
              ...
              ...)
{
  ...
  conversation_invocation_invoke (action_data, PAM_ERROR_MSG, prompt,
                                  notify_conversation_done,
                                  &notify_data, NULL);
