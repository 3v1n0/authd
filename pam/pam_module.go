// Code generated by "pam-moduler -libname pam_authd.so -type pamModule -tags !pam_binary_cli && !pam_binary_exec && !pam_debug"; DO NOT EDIT.

//go:build !pam_binary_cli && !pam_binary_exec && !pam_debug
