// Code generated by "pam-moduler -libname pam_authd.so -type pamModule -tags !pam_binary_cli,!generate -build-tags release"; DO NOT EDIT.

//go:build !pam_binary_cli
//go:build !generate

//go:generate go build "-ldflags=-extldflags -Wl,-soname,pam_authd.so" -buildmode=c-shared -o pam_authd.so -tags go_pam_module,release
