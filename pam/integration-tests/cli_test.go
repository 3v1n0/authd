...
func TestCLIAuthenticate(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Authenticate user with qr code in a TTY":                              {tape: "qr_code", tapeSettings: []tapeSetting{{"Height", 650}}, pamUser: "user-integration-qr-code-tty", termEnv: "linux"},
		"Authenticate user with qr code in a TTY session":                      {tape: "qr_code", tapeSettings: []tapeSetting{{"Height", 650}}, pamUser: "user-integration-qr-code-tty-session", termEnv: "xterm-256color", sessionEnv: "tty"},
		"Authenticate user with qr code in screen":                             {tape: "qr_code", tapeSettings: []tapeSetting{{"Height", 650}}, pamUser: "user-integration-qr-code-screen", termEnv: "screen"},
		"Authenticate user with qr code after many regenerations":              {tape: "qr_code_quick_regenerate", tapeSettings: []tapeSetting{{"Height", 650}}},
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			...
			t.Cleanup(func() { saveArtifactsForDebug(t, []string{cliLog}) })
			...
			tapePath := prepareTape(t, td, "cli", outDir)
